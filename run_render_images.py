...
if __name__ == "__main__":
    ...
    for language in language_list:
        ...
        os.makedirs(f"{args.output_path}/{language}", exist_ok=True)
        
        input_path = os.path.join(args.input_path, language, "train.jsonl") 
        output_path = os.path.join(args.output_path, language, "train.jsonl")
